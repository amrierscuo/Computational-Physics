...
- Q4: diagnostics dashboard and Hovmöller 3D terrain
...
- The green diagnostic signboards in the Hovmöller 3D quadrant were removed.


- V14 removes the remaining diagnostics wall/bar chart in Q4, leaving the Hovmöller 3D quadrant clean.


## V14 additions
- Fly mode: PC uses F toggle, Space up, Ctrl/C down, Shift for speed.
- Mobile controls: joystick movement, right-side camera look, FLY toggle, ↑/↓ altitude.
