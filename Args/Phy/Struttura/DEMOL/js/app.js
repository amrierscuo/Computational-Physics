...
function onControlsUnlock() {
  ...
  if (lockKicker) lockKicker.textContent = state.firstEntryDone ? 'Menu reopened Â· synchronized loop paused' : 'Showroom v23 ready Â· diagnostic top-down map loaded';
