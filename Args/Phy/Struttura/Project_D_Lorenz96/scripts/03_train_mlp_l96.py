"""
Train a small MLP emulator on the Lorenz-96 small dataset.
...
Outputs:
    ...
    figures/mlp_l96_next_small_loss.png
    reports/mlp_l96_next_small_metrics.txt

This is the L96 analogue of the L63 MLP baseline.
It provides a first fully connected benchmark before testing the CNN.
"""
...
def main():
    """
    Train the MLP and save model, loss figure, and metrics.
    """
    data_path = Path("data/l96_small.npz")
    model_path = Path("models/mlp_l96_next_small.pt")
    figure_path = Path("figures/mlp_l96_next_small_loss.png")
    metrics_path = Path("reports/mlp_l96_next_small_metrics.txt")
    ...
    with open(metrics_path, "w") as f:
        f.write("MLP L96 next-state small dataset\n")
        f.write("================================\n")
